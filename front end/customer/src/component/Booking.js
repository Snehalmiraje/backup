    ...
    <div class="row text-center align-items-end">
      <div class="col-lg-4 mb-5 mb-lg-0">
        <div class="bg-white p-5 rounded-lg shadow">
          ...
          <a href="https://rzp.io/l/Q1PE5dj9" class="btn btn-primary btn-block p-2 shadow rounded-pill">Select</a>
        </div>
      </div>
      <div class="col-lg-4 mb-5 mb-lg-0">
        <div class="bg-white p-5 rounded-lg shadow">
          ...
          <a href="https://rzp.io/l/B9p5QlsHK" class="btn btn-primary btn-block p-2 shadow rounded-pill">Select</a>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="bg-white p-5 rounded-lg shadow">
          ...
          <a href="https://rzp.io/l/etx7iLxsdR" class="btn btn-primary btn-block p-2 shadow rounded-pill">Select</a>
        </div>
      </div>
